      ...
      <div className="p-6">
        ...
        {trackingData && (
          <div className="space-y-6">
            ...
            {/* Histories */}
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
              <h2 className="text-lg font-semibold text-slate-800 mb-3">Histories</h2>
              {trackingData.histories.length > 0 ? (
                <div className="space-y-3">
                  {trackingData.histories.map((history, index) => (
                    <div
                      key={history.id}
                      className="border-l-4 border-blue-500 pl-4 py-2 bg-slate-50 rounded-r"
                    >
                      <p className="text-slate-800">{history.comment}</p>
